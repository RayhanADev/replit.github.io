...
For more PyGame inspiration, take a look at our basic [Juggling Game](https://docs.replit.cm/tutorials/07-building-a-game-with-pygame) which includes an example of how to animate objects too.
